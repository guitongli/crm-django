# Generated by Django 3.2.6 on 2021-09-30 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_region', models.CharField(choices=[('UK', 'UK'), ('USA', 'USA'), ('EU', 'EU')], max_length=100)),
                ('special_files', models.FileField(blank=True, null=True, upload_to='')),
                ('client', models.ForeignKey(max_length=20, null=True, on_delete=django.db.models.deletion.SET_NULL, to='order.client')),
            ],
        ),
        migrations.CreateModel(
            name='Agent',
